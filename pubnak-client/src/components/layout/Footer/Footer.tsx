      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="text-gray-400">
              <li className="mb-2">
                <a href="https://www.facebook.com/Anas.NAK.07/">Facebook</a>
              </li>
              <li className="mb-2">
                <a href="https://www.linkedin.com/in/anas-nakhli-31aa83255/">LinkedIn</a>
              </li>
              <li className="mb-2">
                <a href="https://www.instagram.com/anas__nak/">Instagram</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <form>
              <input
                ...
                className="w-full px-4 py-2 mb-2 border border-gray-600 rounded-md bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <button
                type="submit"
