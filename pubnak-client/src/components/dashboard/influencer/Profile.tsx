...
import { updateProfileInfluencer, getUser } from '@/features/userSlice';
...
const Profile: React.FC = () => {
    ...
    const [userData, setUserData] = useState<UserData>({
        ...
        email: user.email || '',
        password: '',
        youtubeLink: user.instagram || '',
        instagramLink: user.youtube || '',
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        formData.append('instagram', userData.instagramLink);
        formData.append('youtube', userData.youtubeLink);
        if (profilePicture) {
    ...
    const dispatchUpdateProfile = (formData: FormData) => {
        try {
            dispatch(updateProfileInfluencer(formData));
        } catch (error) {
